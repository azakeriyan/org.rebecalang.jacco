...
/**
   ...
   This exception indicates that an attempt was made to add a new
   local class, but a class with the given name has already been
   loaded with the <em>NetLoader</em>. <p>
