...
/**
   ...
   This may occur, for example, if names are combined from
   incompatible nameservice implementations, or if a client attempts
   to spoof a name by creating an illegal instance.<p>
