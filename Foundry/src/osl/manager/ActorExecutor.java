...
public class ActorExecutor {
	...
	public Object execute(ActorMsgRequest nextMsg) throws Exception {
    	...
    	//return __process(msgName);
	 	throw new NoSuchMethodException("No message matching \"" + nextMsg.method + "\" in this actor.");
//    	return new MessageProcessResult("", false);
    }
    
/*  private Object __process(String msgName)  throws Exception {
	 	throw new NoSuchMethodException("No method matching \"" + msgName + "\" in this object");
  }
*/
