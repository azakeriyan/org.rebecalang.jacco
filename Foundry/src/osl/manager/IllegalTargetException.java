...
/**
   ...
   This exception indicates that the <em>ActorName</em> specified as
   an argument to a particular method is either ill-formed or does not 
   correspond to a legal actor name. <p>
